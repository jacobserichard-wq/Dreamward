...
export function welcomeEmail(businessName: string) {
  return {
    subject: "Welcome to Dreamward!",
    html: `
      <div style="font-family: -apple-system, sans-serif; max-width: 560px; margin: 0 auto; padding: 40px 24px;">
        <h1 style="font-size: 24px; color: #0f172a; margin: 0 0 16px;">Welcome to Dreamward!</h1>
        ...
        <a href="${baseUrl}" style="display: inline-block; padding: 12px 28px; background: #3b82f6; color: white; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 15px;">Open Dreamward</a>
...
export function paymentFailedEmail(businessName: string) {
  return {
    subject: "Dreamward: Payment failed - action needed",
    html: `
      <div style="font-family: -apple-system, sans-serif; max-width: 560px; margin: 0 auto; padding: 40px 24px;">
        <h1 style="font-size: 24px; color: #0f172a; margin: 0 0 16px;">Payment failed</h1>
        <p style="font-size: 16px; color: #334155; line-height: 1.6; margin: 0 0 24px;">
          Hey ${businessName || "there"}, we were unable to process your latest payment for Dreamward.
...
export function cogsDailyDigestEmail(opts: {
  ...
  return {
    subject: `${opts.businessName || "Dreamward"} — ${dateLabel}: ${fmtUsd(opts.revenue)} sold, ${fmtPct(opts.marginPercent)} margin`,
    html: `
  ...
  return {
    ...
    html: `
      <div style="font-family: -apple-system, sans-serif; max-width: 560px; margin: 0 auto; padding: 40px 24px;">
        ...
        <p style="font-size: 15px; color: #475569; line-height: 1.6; margin: 0 0 16px;">
          Attached is my ${year} business summary from Dreamward for ${businessName},
          in two formats:
        </p>
        ...
        <p style="font-size: 12px; color: #94a3b8; margin: 32px 0 0;">
          Sent via Dreamward. Cash-basis reports — income counted when
