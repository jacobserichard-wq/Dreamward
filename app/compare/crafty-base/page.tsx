        ...
        <div className="max-w-[1100px] mx-auto px-4 sm:px-8">
          ...
          <div className="space-y-6">
            ...
            <CompareSection
              ...
              ourHeading="FlowWork"
              ourCopy="Real-time webhook sync from Shopify, Wix, and Square. Square &ldquo;Custom Amount&rdquo; items are first-class — map them once by name, future sales auto-resolve. Per-SKU COGS computes automatically, no Manufacturing Run needed."
            />
